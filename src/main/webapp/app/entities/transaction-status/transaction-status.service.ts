...
export class TransactionStatusService {
    ...
    private resourceUrl = 'api/transaction-statuses';
    private resourceSearchUrl = 'api/_search/transaction-statuses';

    constructor(private http: Http) { }

    create(transactionStatus: TransactionStatus): Observable<TransactionStatus> {
        let copy: TransactionStatus = Object.assign({}, transactionStatus);
